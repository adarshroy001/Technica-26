...
export function ScrollWordReveal() {
  ...
  return (
    ...
    >
      <h2 className="text-5xl sm:text-7xl font-nord font-extrabold text-toxic-green mb-8 text-center drop-shadow-lg">
        About Us
      </h2>
      <p className="max-w-4xl text-xl sm:text-center sm:text-2xl leading-relaxed font-nord  text-gray-300">
...
function Word({ children, progress, range }: WordProps) {
  ...
  const extendedOpacity = useTransform(opacity, (value) =>
    Math.max(value, opacity.get())
  );
