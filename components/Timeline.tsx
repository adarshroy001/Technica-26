...
const timelineEvents = [
  {
    ...
    title: "Ignition",
    description: "Inauguration & Opening ceremony of Technica'26",
    icon: Beaker,
    purity: "98.1%",
  },
  {
    ...
    title: "Synthesis",
    description:
      "Main rounds, competitions, industrial visits, fun activities, esports, and networking sessions.",
    icon: Flame,
    purity: "99.1%",
  },
  {
    ...
    title: "Fusion",
    description:
      "Creative competitions, industrial visits, technical quizzes, cultural night, final rounds, prize distribution, and closing ceremony.",
    icon: Trophy,
    purity: "99.9%",
  },
];
    ...
    >
      ...
      <div className={`flex-1 ${isEven ? "md:text-right" : "md:text-left"}`}>
        ...
        <div className="relative inline-block mb-4">
          ...
          <motion.div
            className={`absolute -bottom-2 h-[3px] bg-gradient-to-r from-[#2ecc71] to-[#0be881] rounded-full ${
      ...
      <div className="hidden md:flex flex-col items-center pt-2">
        ...
        <motion.div
          className={`hidden md:block absolute w-12 h-[2px] bg-gradient-to-r from-[#2ecc71]/50 to-transparent top-[10px] ${
            isEven ? "right-full mr-1" : "left-full ml-1 rotate-180"
          }`}
          initial={{ scaleX: 0 }}
