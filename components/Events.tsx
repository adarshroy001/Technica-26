...
export const eventsData = [
  {
    id: 1,
    name: 'MetalForge',
    description: 'Metallurgical case study competition where teams analyze real-world industrial challenges and propose innovative solutions.',
    prizepool: '₹50,000',
    images: [
  ...
  },
  {
    id: 2,
    name: 'CodeCrystal',
    description: 'Competitive programming hackathon pushing the boundaries of algorithmic thinking and problem-solving skills.',
    prizepool: '₹75,000',
    images: [
  ...
  },
  {
    id: 3,
    name: 'MaterialQuest',
    description: 'Materials science treasure hunt combining theoretical knowledge with hands-on exploration across campus.',
    prizepool: null,
    images: [
  ...
  },
  {
    ...
    description: 'Startup idea presentation competition where innovators pitch their breakthrough concepts to industry experts.',
    prizepool: '₹1,00,000',
    images: [
  ...
  },
  {
    id: 5,
    name: 'TechQuiz',
    description: 'Technical trivia championship testing your knowledge across science, technology, and engineering domains.',
    prizepool: '₹25,000',
    images: [
      '/images/events/techquiz-1.jpg',
    ],
  },
  {
    id: 6,
    name: 'RoboWars',
    description: 'Robotics combat competition where custom-built bots battle for supremacy in the arena.',
    prizepool: '₹80,000',
    images: [
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        >
          ...
          <h2 className="text-4xl md:text-5xl lg:text-6xl font-black text-white mb-4">
            Featured <span className="text-transparent bg-clip-text bg-gradient-to-r from-[#2ecc71] via-[#0be881] to-[#10ac84]">Events</span>
          </h2>
        </motion.div>
                ...
                >
                  ...
                  <div className="relative w-full h-full bg-gradient-to-br from-[#2ecc71]/20 via-gray-900 to-black">
                    ...
                    <div className="absolute top-6 left-6 font-mono text-[#2ecc71] text-sm tracking-wider">
                      ...
                      <span className="text-gray-600">0{eventsData.length}</span>
                    </div>
                ...
                >
                  ...
                  {currentEvent.prizepool && (
                    <div className="flex items-center gap-3">
                      <span className="font-mono text-xs text-gray-500 uppercase tracking-wider">Prize Pool</span>
                      <span className="font-mono text-2xl font-bold text-[#2ecc71]">{currentEvent.prizepool}</span>
                    </div>
                  )}

                  {/* CTA */}
                  <Link
                    href={`/events#${currentEvent.name.toLowerCase().replace(/\s+/g, '-')}`}
